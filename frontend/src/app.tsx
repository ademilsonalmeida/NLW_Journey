...
export function App() {
  const [isGuestsInputeOpen, setIsGuestsInputeOpen] = useState(false)
        ...
        <div className="space-y-4">
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <div className="flex flex-1 items-center gap-2">
              ...
              <input
                disabled={isGuestsInputeOpen}
                type="text"
                placeholder="Para onde você vai?"
                className="bg-transparent text-lg placeholder-zind-400 outline-none w-full"
              />
            </div>
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                type="text"
                placeholder="Quando?"
                className="bg-transparent text-lg placeholder-zind-400 outline-none w-36"
              />
            </div>
